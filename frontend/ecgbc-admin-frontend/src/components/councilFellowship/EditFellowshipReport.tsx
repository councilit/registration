...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, TextField, CircularProgress, Stack, Box, Typography, FormControl, FormLabel } from '@mui/material';
import { Report, UpdatedReport } from '../../types/model/report.model';
import { useAppDispatch, useAppSelector } from '../../store/store';
import { updateFellowshipReport } from '../../store/features/report.slice';
...
interface EditFellowshipReportProps {
  open: boolean;
  handleClose: () => void;
  report: Report;
  fellowshipId: string;
...
const EditFellowshipReport: React.FC<EditFellowshipReportProps> = ({ open, handleClose, report }) => {
  ...
  const handleDownload = (fileUrl: string): void => {
    ...
    link.href = fileUrl;
    link.download = `fellowship-${report.year}-report`; // Optionally set the filename, e.g., 'downloaded-file.pdf'
  ...
  const handleSubmit = () => {
    ...
    dispatch(updateFellowshipReport({
      updatedReport: {
...
export default EditFellowshipReport;
