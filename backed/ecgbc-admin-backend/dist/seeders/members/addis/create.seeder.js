...
const seedMembers = () => __awaiter(void 0, void 0, void 0, function* () {
    const data = (yield (0, node_1.default)(path_1.default.join(__dirname, "addis_n.xlsx")));
    ...
    const fellowhip = yield db_config_1.default.councilFellowship.create({
        data: {
            name: "የኢትዮጵያ ወንጌል አማኞች አብያተ ክርስቲያናት የተመዘገቡ አዲስ ሚኒስትሪዎች",
    ...
    const duplicateMembers = ['5252', '5348', '52101', '5422', '5492', '5147'];
