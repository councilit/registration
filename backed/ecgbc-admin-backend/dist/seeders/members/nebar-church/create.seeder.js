...
const seedMembers = () => __awaiter(void 0, void 0, void 0, function* () {
    console.log('starting seedMembers for nebar church');
    const data = (yield (0, node_1.default)(path_1.default.join(__dirname, "nebar_church.xlsx")));
    ...
    const duplicateMembers = ['2140', '2212', '5388'];
