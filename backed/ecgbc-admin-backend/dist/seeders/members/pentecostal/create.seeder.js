...
const member_report_validator_1 = require("../validators/member-report-validator");
...
const seedMembers = () => __awaiter(void 0, void 0, void 0, function* () {
    const data = (yield (0, node_1.default)(path_1.default.join(__dirname, "pentecostal.xlsx")));
        ...
        try {
            if (row[0] !== null) {
                ...
                members.push({
                    ...
                    region,
                    city: row[4],
                    certificateIssuedDate: (0, ethiopian_date_helper_1.ethToGreg)(row[7], row[0]),
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (row[0] !== null) {
                ...
                yield (0, member_report_validator_1.validateMemberReport)(row[9], row[10], row[11], row[0]);
            }
        }
        catch (error) {
