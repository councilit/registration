...
const seedMembers = () => __awaiter(void 0, void 0, void 0, function* () {
    const data = (yield (0, node_1.default)(path_1.default.join(__dirname, "ecfe.xlsx")));
        ...
        try {
            if (row[0] !== null) {
                ...
                members.push({
                    ...
                    certificateNo: row[8] === null ? (0, crypto_1.randomInt)(1000, 99999).toString() : row[8].toString(),
                    boardMembers: [],
                    reports: [],
                });
                if (row[1] !== null) {
    ...
    const duplicateMembers = ['08262', '0874'];
