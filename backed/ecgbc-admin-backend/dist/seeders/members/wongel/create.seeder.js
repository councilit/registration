...
const seedMembers = () => __awaiter(void 0, void 0, void 0, function* () {
    const data = (yield (0, node_1.default)(path_1.default.join(__dirname, "wongel.xlsx")));
    ...
    const fellowhip = yield db_config_1.default.councilFellowship.create({
        data: {
            name: "የኢትዮጵያ የወንጌል ባለአደራዎች አብያተ ክርስቲያናት ህብረት ",
    ...
    yield Promise.all(members.map((member) => __awaiter(void 0, void 0, void 0, function* () {
        yield db_config_1.default.member.create({
            // where: { certificateNo: member.certificateNo },
            data: {
                name: member.name,
