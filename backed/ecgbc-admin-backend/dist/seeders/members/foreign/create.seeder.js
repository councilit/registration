...
const seedMembers = () => __awaiter(void 0, void 0, void 0, function* () {
    const data = (yield (0, node_1.default)(path_1.default.join(__dirname, "foreign.xlsx")));
    ...
    const fellowhip = yield db_config_1.default.councilFellowship.create({
        data: {
            name: "የውጭ አገራት ሚኒስትሪዎች እና ቤተ እምነቶች",
        ...
        try {
            ...
            yield db_config_1.default.member.create({
                ...
                data: {
                    ...
                    isInEthiopia: ["Ethiopia", "ኢትዮጵያ"].includes(member.country) ? true : false,
                },
            });
        }
        catch (error) {
