...
exports.fromGeezNumber = fromGeezNumber;
exports.toEthiopianShortDate = toEthiopianShortDate;
exports.toGeezDate = toGeezDate;
exports.toEthiopianGeezLong = toEthiopianGeezLong;
exports.convertEthiopianToGregorian = convertEthiopianToGregorian;
exports.toGeezNumber = toGeezNumber;
exports.getEthiopianDate = getEthiopianDate;
exports.getNextEthiopianHoliday = getNextEthiopianHoliday;
...
function convertEthiopianToGregorian(ethiopianYear, ethiopianMonth, ethiopianDay) {
    ...
    if (ethiopianMonth < newYearMonth ||
...
function getNextEthiopianHoliday(today) {
    ...
    const ethiopianHolidays = [
        {
            ...
            notes: "Commemorates Ethiopians victory over Italy at Battle of Adwa in 1896.",
        },
        {
            date: "01-May",
        ...
        },
        {
            ...
            notes: "Commemorates the 1941 entering of Emperor Haile Selassie into Addis Ababa amidst Second World War.",
        },
        {
            date: "28-May",
        ...
        },
        {
            ...
            notes: "Commemorating the formation of the Ethiopian National Defense Force in 1907",
        },
        {
            date: "07-Jan",
        ...
        },
        {
            ...
            notes: "Celebrated on January 19th, marks the Ethiopian Orthodox Epiphany.",
        },
        {
            date: "27-Sep",
            englishName: "Meskel",
    ...
    const holidaysWithDateObjects = ethiopianHolidays.map((holiday) => {
        ...
        return Object.assign(Object.assign({}, holiday), { date: dateThisYear });
    });
